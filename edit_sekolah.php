...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE data_sekolah SET nama_sekolah = :nama_sekolah, lokasi_sekolah = :lokasi_sekolah WHERE id = :id");
    $stmt->execute(['nama_sekolah' => $namaSekolah, 'lokasi_sekolah' => $lokasiSekolah, 'id' => $id]);
...
$id = $_GET['id'];
$stmt = $pdo->prepare("SELECT * FROM data_sekolah WHERE id = :id");
$stmt->execute(['id' => $id]);
...
<head>
    <meta charset="UTF-8" />
    <title>Edit Data Sekolah - Sukarobot Academy</title>
        ...
        <div class="container mt-5">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_sekolah" class="form-control" value="<?= htmlspecialchars($sekolah['nama_sekolah']) ?>" required>
                </div>
                <div class="mb-3">
                    <label for="lokasi_sekolah" class="form-label">Lokasi Sekolah:</label>
                    <input type="text" name="lokasi_sekolah" class="form-control" value="<?= htmlspecialchars($sekolah['lokasi_sekolah']) ?>" required>
                </div>
